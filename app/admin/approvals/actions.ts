...
// Redirect-free counterparts to the lawyer-portal approve/publish actions —
// keeps the admin on /admin/approvals and updates in place instead of
// navigating away after every single approval.
