...
export const metadata: Metadata = {
  title: 'How RegWatch Works — AI-Powered Intelligence, Human-Approved | MN Advocates LLP',
  description:
  ...
  openGraph: {
    ...
    description:
      'A four-step pipeline — ingestion, AI analysis, lawyer review, and delivery — ensures every briefing is accurate, timely, and approved by a qualified advocate.',
